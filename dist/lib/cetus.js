...
function makeCETUSPTB(txb, poolId, byAmountIn, coinA, amount, a2b, typeArguments) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [cetusReceiveA, cetusReceiveB, cetusflashReceipt] = txb.moveCall({
            target: `${config_1.config.CETUSPACKAGEID}::pool::flash_swap`,
            arguments: [
                txb.object(config_1.config.CETUSCONFIGID),
                txb.object(poolId),
                txb.pure.bool(a2b),
        ...
        txb.moveCall({
            target: `${config_1.config.CETUSPACKAGEID}::pool::swap_pay_amount`,
        ...
        if (a2b) {
            ...
            txb.moveCall({
                target: `${config_1.config.CETUSPACKAGEID}::pool::repay_flash_swap`,
                arguments: [
                    txb.object(config_1.config.CETUSCONFIGID),
                    txb.object(poolId),
                    coinA,
