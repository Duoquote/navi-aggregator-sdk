...
function makeKriyaV3PTB(txb, poolId, byAmountIn, coinA, amount, a2b, typeArguments) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const args = [
            ...
            txb.object(config_1.config.CLOCK_ADDRESS),
            txb.object(config_1.config.KRIYA_V3_VERSION),
        ];
        const [receive_balance_a, receive_balance_b, receipt] = txb.moveCall({
            target: `${config_1.config.KRIYA_V3_PACKAGEID}::trade::flash_swap`,
        ...
        if (a2b) {
            ...
            txb.moveCall({
                target: `${config_1.config.KRIYA_V3_PACKAGEID}::trade::repay_flash_swap`,
                arguments: [
                    txb.object(poolId),
                    receipt,
                    BalanceA,
